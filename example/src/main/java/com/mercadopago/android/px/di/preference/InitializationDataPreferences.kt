...
import com.mercadopago.android.px.feature.custom_initialize.*
import com.mercadopago.android.px.feature.custom_initialize.ConfigurationBooleanData
import com.mercadopago.android.px.feature.custom_initialize.ConfigurationDataType
...
internal class InitializationDataPreferences(private val preferences: SharedPreferences) {
    ...
    fun saveInitializationData(data: InitializationData) {
        preferences.edit()?.apply {
            ...
            putString(PROCESSOR_TYPE, data.processor.value.name)
            apply()
        }
    }
    ...
    fun getInitializationData() = InitializationData(
        ...
        ConfigurationDataType.Processor(ProcessorType.valueOf(
            preferences.getString(PROCESSOR_TYPE, ProcessorType.DEFAULT.name) ?: ProcessorType.DEFAULT.name)))
